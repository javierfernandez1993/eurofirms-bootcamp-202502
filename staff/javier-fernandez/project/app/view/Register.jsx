    ...
    return <div className="p-5">
        ...
        <form className="mt-2 flex flex-col gap-4" onSubmit= {handleRegisterSubmit}>
            ...
            <div className="flex flex-col gap">
                ...
                <input className="border-3 px-2" style= {{fontFamily: "'Rock Salt'"}} type="text" id="email" name="email" placeholder="your e-mail"/>
            </div>

            <div className="flex flex-col gap">
                <label htmlFor="password">Password</label>
                <input className="border-3 px-2" style= {{fontFamily: "'Rock Salt'"}} type="password" if="password" name="password" placeholder="your password"/>
            </div>
